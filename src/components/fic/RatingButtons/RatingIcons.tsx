...
const dislikeIcon = (size: number, isBlank: boolean) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size + (size * .1)} viewBox="5 -10 53.6 69.3">
